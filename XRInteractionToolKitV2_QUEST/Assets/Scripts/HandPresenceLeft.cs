...
public class HandPresence : MonoBehaviour
{
    ...
    // Virtual Hand Coordinates {Rv, Φ, θ} and distance.
    ...
    void Update()
    {
        ...
        float distanceToOrigin = Vector3.Distance(spawnedHandModel.transform.position, chestOrigin.transform.position);
        ...
        else
        {
            ...
            virtualHandPosition = 
				...
				0.5f * (virtualHand.transform.position + (virtualHand.transform.position - chestOrigin.transform.position).normalized * virtualHandDistance);
...
public class HandPresenceLeft : MonoBehaviour
{
    ...
    public float armlength = 12.2f; // Length of arm = 0.6cm * 20
    ...
    void Update()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                gogo = k * Mathf.Pow((distanceToOrigin - D), 2.0f);
            }
