/* ************************************ GO-GO-Technique 3 (Working) ************************************ */
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
using UnityEngine.XR;

public class ThirdTechnique : MonoBehaviour
{
    ...
    public void Start()
    {
		...
		thresholdD = 0.50f * this.armLenght;
		gogoFactorK = 21.0f;  // 0 < k < 21
		
		Debug.Log("Start Go-Go Technique 3");
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (distanceToOrigin > this.thresholdD)
            {
                ...
                gogo = gogoFactorK * Mathf.Pow((distanceToOrigin - thresholdD), 2.0f);
            }
            else
            {
                // Use Linear mapping
