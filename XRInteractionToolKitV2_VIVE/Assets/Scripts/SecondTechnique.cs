/* ************************************ GO-GO-Technique 2 (Working) ************************************ */
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
using UnityEngine.XR;

public class SecondTechnique : MonoBehaviour
{
    ...
    {   
		...
		gogoFactorK = 21.00f; // 0 < k < 21
		
		Debug.Log("Start Go-Go Technique 2");
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                // Use Exponential mapping (instantaneously, i.e. without a threshold)
                // Mapping for: Rr + k(Rr - D)^4   otherwise
                gogo = gogoFactorK * Mathf.Pow(distanceToOrigin, 4.0f);
                //Debug.Log("distance To Origin = " + distanceToOrigin);
            }
